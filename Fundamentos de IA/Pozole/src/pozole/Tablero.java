...
public class Tablero extends JFrame //---------
{
    ...
    private final String start = "123456789ABCDE0F";  //----***************
    private final String goal  = "123456789ABCDEF0";  //----***************
    
    //private final String start = "283164705";  //----*************** F2E83D16A47C0B59
    ...
    private final int maxDepth = 10000; // Para limitar la profundidad del árbol//***********************************************+
   ...
   // Parte la imagen en piezas 
    ...
    {
        if(e.getSource()==solveD) depth=true;  // En caso de que se trate de búsqueda en profundidad
        solve();
    }
    
    // Este es el método implementa el algoritmo de búsqueda
    ...
    private void solve()
    {
        ...
        boolean depthCond = false;
        dr=0;
        int m=0;
        long startTime = System.currentTimeMillis();
        while(!queue.isEmpty() && !success && !depthCond)
        {
            m++;
            int validStates = 0;      
        ...
        {   
            ...
            if(depth) this.setTitle("15-Puzzle (Deep-First Search)");
